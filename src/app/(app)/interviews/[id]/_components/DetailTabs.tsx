...
export default function DetailTabs({ transcript, insightsEnabled, insightsProps }: Props) {
  ...
  return (
    <div>
      ...
      {/* Both panels stay mounted; inactive one is hidden so audio/wavesurfer state survives. */}
